...
public class Weapon : MonoBehaviour 
{
    ...
    void Start(){
        ...
        //Find the fireEvent of a Hero Componenet in the parent hierarchy
    ...
    public void SetType(eWeaponType wt){
        ...
        //Get the WeaponDefintion for this type from Main
        ...
        nextShotTime = 0; //You can fire immediatly after each _type is set
    }

    private void Fire(){
        //If thie.gameObject is inactive return
